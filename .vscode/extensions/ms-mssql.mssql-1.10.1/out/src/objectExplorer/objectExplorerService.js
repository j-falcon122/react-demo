    ...
    handleSessionCreatedNotification() {
        ...
        const handler = (result) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.success) {
                ...
                if ((_a = self._currentNode.connectionCredentials) === null || _a === void 0 ? void 0 : _a.password) {
    ...
    removeObjectExplorerNode(node, isDisconnect = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!isDisconnect) {
                ...
                let disconnectedNode = new treeNodeInfo_1.TreeNodeInfo(label, Constants.disconnectedServerLabel, node.collapsibleState, node.nodePath, node.nodeStatus, Constants.disconnectedServerLabel, undefined, node.connectionCredentials, node.parentNode);
