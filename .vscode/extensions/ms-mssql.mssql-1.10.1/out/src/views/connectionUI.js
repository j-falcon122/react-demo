...
class ConnectionUI {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (profile.accountId) {
                ...
                if (selection === LocalizedConstants.azureAddAccount) {
                    profile = yield azureController.getTokens(profile, this._accountStore, providerSettings_1.default.resources.azureManagementResource);
                }
                let account = this._accountStore.getAccount(profile.accountId);
                this.connectionManager.accountService.setAccount(account);
            }
    ...
    promptForCreateProfile() {
        return connectionProfile_1.ConnectionProfile.createProfile(this._prompter, this._connectionStore, this._context, this._accountStore);
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this._vscodeWrapper.showErrorMessage(errorMessage, LocalizedConstants.retryLabel).then(result => {
                if (result === LocalizedConstants.retryLabel) {
                    return connectionProfile_1.ConnectionProfile.createProfile(this._prompter, this._connectionStore, this._context, this._accountStore, profile);
                }
                else {
                    return undefined;
                }
